...
export default function AdminLayout({ children }) {
  ...
  const navLinks = [
    ...
    { href: "/admin/addproducts", label: "Add Product", icon: Package },
    { href: "/admin/allproducts", label: "All Products", icon: ShoppingCart },
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-tr from-gray-100 via-gray-200 to-gray-300 text-gray-800">
      {/* Sidebar */}
      <aside className="w-72 h-full bg-gradient-to-b from-indigo-700 via-indigo-800 to-indigo-900 text-white shadow-2xl flex flex-col justify-between rounded-r-3xl overflow-hidden">
        {/* Top Section */}
        <div>
          {/* User Info */}
          <motion.div
